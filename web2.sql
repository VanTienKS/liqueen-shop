...
CREATE TABLE IF NOT EXISTS `enter_coupon` (
  ...
  CONSTRAINT `coupon_staff_fk3` FOREIGN KEY (`staff_id`) REFERENCES `user` (`id`),
...
-- Dumping structure for table web2.token
...
-- Dumping data for table web2.token: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `FK_user_ward` (`ward_id`),
  KEY `FK_user_role` (`role_id`),
  CONSTRAINT `FK_user_role` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`),
  CONSTRAINT `FK_user_ward` FOREIGN KEY (`ward_id`) REFERENCES `ward` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Dumping data for table web2.user: ~0 rows (approximately)
